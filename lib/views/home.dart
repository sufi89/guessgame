        ...
        child: Column(  
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child:Row(
                children: <Widget>[
                  Text("Guses",style: TextStyle(color: const Color(0xfff44336),fontSize: 40.0.sp,fontWeight: FontWeight.bold,letterSpacing: 2.sp)),
                   SizedBox(
                    width: 5.0.w,
                  ),
                ],
            ...
            SizedBox(
              ...
              child: TextButton(
                ...
                style: TextButton.styleFrom(
                    backgroundColor: const Color(0xfff44336),elevation: 14.0,padding: EdgeInsets.symmetric(vertical: 20.h),shadowColor:const Color(
